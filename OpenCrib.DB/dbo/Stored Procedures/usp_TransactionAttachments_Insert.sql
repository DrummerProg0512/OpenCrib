...
CREATE PROCEDURE [dbo].[usp_TransactionAttachments_Insert]
    ...
    @ImageActive BIT = 1,
    @UploadedBy INT,
    @TransactionAttachmentID INT OUTPUT
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN TRY
        ...
        -- Insert the record
        INSERT INTO [dbo].[TransactionAttachments]
            ([TransactionID], [ImageData], [FileName], [FileDescription], [FileType], 
        ...
        SET @TransactionAttachmentID = SCOPE_IDENTITY();
